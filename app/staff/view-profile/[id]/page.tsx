// file: app/staff/view-profile/[id]/page.tsx
"use client";
...
const text = {
  en: {
    ...
    back: "Back",
    backManage: "Back to Manage Alumni",
    tabs: {
      posts: "Posts",
      about: "About & Contact",
  ...
  mm: {
    ...
    back: "နောက်သို့",
    backManage: "ကျောင်းသားဟောင်းများ စီမံရန်သို့ ပြန်သွားရန်",
    tabs: {
      posts: "ပို့စ်များ",
...
export default function ProfilePage() {
  ...
  const lang: Lang = langParam === "mm" ? "mm" : "en";
  const t = text[lang];
    ...
    return (
      <main className="min-h-screen bg-[#eef2f7] text-slate-950 dark:bg-slate-950 dark:text-white">
        <div className="flex min-h-screen">
          ...
          <section className="flex min-w-0 flex-1 items-center justify-center px-4 pb-8 pt-20 sm:px-6 lg:px-8 lg:pt-8">
    ...
    return (
      <main className="min-h-screen bg-[#eef2f7] text-slate-950 dark:bg-slate-950 dark:text-white">
        <div className="flex min-h-screen">
          ...
          <section className="flex min-w-0 flex-1 items-center justify-center px-4 pb-8 pt-20 text-center text-base font-bold text-slate-500 sm:px-6 lg:px-8 lg:pt-8">
        ...
        <section className="min-w-0 flex-1 px-4 pb-8 pt-20 sm:px-6 lg:px-8 lg:pt-8">
          ...
          <div className="relative h-28 bg-gradient-to-br from-[#00BFC4] via-[#77edec] to-[#339e9e] sm:h-36">
            ...
            <Link
              ...
              className="absolute left-3 top-3 inline-flex items-center gap-1.5 rounded-full border border-white/40 bg-white/85 px-3.5 py-2 text-xs font-black text-slate-700 shadow-sm backdrop-blur transition hover:bg-white hover:text-slate-900 active:scale-95 sm:left-4 sm:top-4"
            >
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <Link
                          href={`/staff/view-profile/${profileData._id}`}
