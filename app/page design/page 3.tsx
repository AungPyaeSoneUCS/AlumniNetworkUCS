...
const text = {
  ...
  mm: {
    badge: "ကျောင်းသားဟောင်းများ အသိုက်အဝန်း",
    line1: "Hinthada Computer",
    line2: "Science & Technology",
    line3: "Alumni Network",
    subtitle: "ကျောင်းသားဟောင်းများချိတ်ဆက်မှု • ဆက်ဆံရေး • နှင့်အတူတကွအလုပ်အကိုင်အခွင့်အလမ်းများ",
    slogan: "ပြည်တွင်းပြည်ပရှိ UCSH ကျောင်းသားဟောင်းများအားလုံးအတွက်ပလက်ဖောင်း",
    join: "အခုပူးပေါင်းပါ",
    feeds: "Feeds ကြည့်ရန်",
    login: "Login ဝင်ရန်",
    directory: "Directory ကြည့်ရန်",
    explore: "Platform ကို လေ့လာပါ",
    sectionTitle: "Alumni Network မှ ဘာတွေရနိုင်လဲ?",
    cards: [
      {
        title: "Feeds",
        href: "/feeds",
        icon: Newspaper,
        description:
          "ကျောင်းသားဟောင်းများ၏ သတင်းများနှင့် ကြေညာချက်များကို သိရှိပြီး event များကို နားလည်စေနိုင်ပါသည်။",
        button: "Feeds ဖွင့်ရန်",
      },
      {
        title: "Directory",
        href: "/directory",
        icon: Users,
        description:
          "သင့်အိမ်ထောင်စု ကျောင်းသားဟောင်းများနှင့် လက်ရှိကျောင်းသားများအားလုံးနှင့် alumni များကို ဆက်သွယ်နိုင်ပါသည်။",
        button: "Directory ကြည့်ရန်",
      },
      {
        title: "Jobs",
        href: "/jobs",
        icon: Briefcase,
        description:
          "Alumni များ၏ အလုပ်ခွင်အသေးစိတ်များကို ကြည့်ရှုပြီး အလုပ်အကိုင်အခွင့်အလမ်းများကို ကြည့်ရှုနိုင်ပါသည်။",
        button: "Jobs ကြည့်ရန်",
      },
      {
        title: "Messages",
        href: "/messages",
        icon: MessageCircle,
        description:
          "Alumni များနှင့် တိုက်ရိုက် message သတင်းပို့ဆက်သွယ်နိုင်ပါသည်။",
        button: "Message ပို့ရန်",
      },
      {
        title: "Contact",
        href: "/contact",
        icon: Mail,
        description:
          "မည်သည့်အကြောင်းအရာဖြစ်စေ alumni network office ကို ဆက်သွယ်နိုင်ပါသည်။",
        button: "ဆက်သွယ်ရန်",
      },
      {
        title: "Profile",
        ...
        icon: UserRound,
        description:
          "ကိုယ်ပိုင်အကောင့်သတင်းအချက်အလက်များကို ပြင်ဆင်ပြီး skill နှင့် experience များကို ပြင်ဆင်နိုင်ပါသည်။",
        button: "Profile ကြည့်ရန်",
      },
    ],
  },
};
