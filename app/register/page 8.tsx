...
const text = {
  ...
  mm: {
    ...
    subtitle:
      "Admin á€™á€¾ á€¡á€á€Šá€ºá€•á€¼á€¯á€‘á€¬á€¸á€žá€±á€¬ á€¡á€á€»á€€á€ºá€¡á€œá€€á€ºá€™á€»á€¬á€¸á€–á€¼á€„á€·á€º Alumni Network á€žá€­á€¯á€· á€á€„á€ºá€›á€±á€¬á€€á€ºá€•á€«á‹",
    step1: "Approval",
    step2: "Account",
    step3: "OTP",
    name: "á€¡á€™á€Šá€º",
    ...
    rollNumber: "Roll Number",
    nrc: "NRC",
    region: "á€á€­á€¯á€„á€ºá€¸/á€•á€¼á€Šá€ºá€”á€šá€º",
      ...
      try {
        ...
        if (validRows.length > 0) {
          ...
          const defaultTownship =
            validRows.find(
              (item) => item.nrc_code === "14" && item.name_mm === "á€Ÿá€žá€",
