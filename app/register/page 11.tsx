...
export default function RegisterPage() {
  ...
  const nrcCandidates = useMemo(() => {
    ...
    const generateSpacingVariations = (r: string, n: string) => [
      `${r}/${c}${t}${n}`,           // áá„/á€Ÿá€žá€(á€”á€­á€¯á€„á€º)áá‚áƒá„á…á† (No spaces)
      `${r}/${c}${t} ${n}`,          // áá„/á€Ÿá€žá€(á€”á€­á€¯á€„á€º) áá‚áƒá„á…á† (Space before number)
      `${r}/${c} ${t}${n}`,          // áá„/á€Ÿá€žá€ (á€”á€­á€¯á€„á€º)áá‚áƒá„á…á† (Space before type)
      `${r}/${c} ${t} ${n}`,         // áá„/á€Ÿá€žá€ (á€”á€­á€¯á€„á€º) áá‚áƒá„á…á† (Space around type)
      `${r}/ ${c}${t}${n}`,          // áá„/ á€Ÿá€žá€(á€”á€­á€¯á€„á€º)áá‚áƒá„á…á† (Space before code)
      `${r} /${c}${t}${n}`,          // áá„ /á€Ÿá€žá€(á€”á€­á€¯á€„á€º)áá‚áƒá„á…á† (Space before slash)
      `${r} / ${c} ${t} ${n}`,       // áá„ / á€Ÿá€žá€ (á€”á€­á€¯á€„á€º) áá‚áƒá„á…á† (Spaced everywhere)
    ];
