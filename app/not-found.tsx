...
export default function NotFound() {
  ...
  const text = {
    ...
    mm: {
      badge: "ပျောက်နေသည့် စာမျက်နှာ",
      code: "၄၀၄",
      title: "ပျောက်နေသည့် စာမျက်နှာ",
      subtitle:
        "သင်ရှာနေသည့် စာမျက်နှာ မရှိတော့ပါ သို့မဟုတ် ရွှေ့ပြောင်းထားပါသည်။",
      hint: "Alumni Network သို့ ပြန်သွားပြီး ဆက်လက်ရှာဖွေပါ။",
      home: "ပင်မစာမျက်နှာ",
      directory: "Directory ဖွင့်ရန်",
      seeMore: "ပိုမိုကြည့်ရန်",
      seeLess: "ပိတ်ရန်",
      feeds: "Feeds ဖွင့်ရန်",
      jobs: "Jobs ကြည့်ရန်",
      contact: "ဆက်သွယ်ရန်",
    },
  }[currentLang];
