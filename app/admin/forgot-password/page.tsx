...
const text = {
  en: {
    ...
    subtitle: "Admin Reset",
    hero: "Enter your admin email and we will send you a code to reset your password safely.",
    backToLogin: "Back to Login",
    title: "Forgot Password",
    access: "Enter your admin email to receive a reset code.",
    steps: ["Email", "OTP", "New Password", "Done"],
    emailLabel: "Admin Email",
    emailPlaceholder: "admin@ucsh.edu.mm",
    sending: "Sending...",
    sendOtp: "Send OTP",
    ...
    successText: "Your password has been reset. Signing you in to the Admin Dashboard...",
    connecting: "Connecting to /admin/dashboard",
    enterPassword: "Enter your new password.",
    passwordRequirement:
      "Use at least 8 characters and 3 of these: uppercase, lowercase, number, or symbol.",
    footer: "Alumni Network • Admin",
  ...
  mm: {
    ...
    subtitle: "Admin စကားဝှက် ပြန်လည်သတ်မှတ်ခြင်း",
    hero: "သင့် Admin Email ထည့်ပါ။ စကားဝှက် ပြန်လည်သတ်မှတ်ရန် ကုဒ်တစ်ခု ပေးပို့ပါမည်။",
    backToLogin: "Login သို့ ပြန်သွားရန်",
    title: "စကားဝှက် မေ့ခဲ့ပါသလား",
    access: "သင့် Admin Email ထည့်၍ ပြန်လည်သတ်မှတ်ရန် ကုဒ် ရယူပါ။",
    ...
    successText: "သင့်စကားဝှက်ကို ပြန်လည်သတ်မှတ်ပြီးပါပြီ။ Admin Dashboard သို့ ဝင်ရောက်နေပါသည်...",
    connecting: "/admin/dashboard သို့ ချိတ်ဆက်နေသည်",
